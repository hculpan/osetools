...
func CampaignsTemplate(appTitle string, username string, campaigns []db.GetCampaignsWithCharacterCountRow, authorized bool) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, c := range campaigns {
			...
			var templ_7745c5c3_Var2 templ.SafeURL = templ.SafeURL("/characters/" + strconv.Itoa(int(c.ID.(int64))))
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `cmd/web/templates/campaignstemplate.templ`, Line: 31, Col: 112}
			}
